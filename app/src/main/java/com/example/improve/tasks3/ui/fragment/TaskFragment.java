package com.example.improve.tasks3.ui.fragment;
 ...
 */
public class TaskFragment extends Fragment implements Callback<ArrayList<Task>> {
    ...
    public void onResponse(Call<ArrayList<Task>> call, Response<ArrayList<Task>> response) {
        //Se llama si se obtuvo una respuesta
        if(response.isSuccessful())
        {
            //Respuesta adecuada
            ArrayList<Task> tasks = response.body();
            //Imprimir por consola el tamaño del arreglo
            Log.d("onResponse tasks", "Size of tasks => " + tasks.size());
            //Asignamos valores al adapter
